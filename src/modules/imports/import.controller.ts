...
import { ApiConsumes, ApiBody, ApiTags, ApiOperation, ApiParam, ApiResponse, } from '@nestjs/swagger';
...
export class ImportController {
    ...
    @ApiOperation({
        ...
        description: 'Xóa ImportFile, Customer thuộc file đó, ProjectNewSale / ProjectTransfer và ProjectDetail không còn được sử dụng',
    })
    @ApiParam({ name: 'id', description: 'ID của ImportFile', example: 'c1c8c8c4-9c2d-4b5f-9c91-2a8c9f0e1234' })
    @ApiResponse({
        status: 200, description: 'Xóa thành công',
        schema: { example: { message: 'Đã xóa toàn bộ dữ liệu của file import' } },
    })
