...
export class AutoMigration1773199708764 implements MigrationInterface {
    name = 'AutoMigration1773199708764'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`project_transfers\` (\`id\` varchar(36) NOT NULL, \`first_interaction_transfer\` date NULL, \`closest_interaction_transfer\` date NULL, \`result_transfer\` varchar(255) NOT NULL, \`expected_selling_price_transfer\` bigint NOT NULL, \`expected_rental_price_transfer\` bigint NOT NULL, \`note_expected_transfer\` varchar(255) NULL, \`project_detail_id\` varchar(36) NOT NULL, \`customerId\` varchar(36) NOT NULL, \`outsideSaleId\` varchar(36) NULL, \`employeeId\` varchar(36) NULL, \`importFileId\` varchar(36) NULL, INDEX \`IDX_a633c12fc5edc94737c90dcca6\` (\`customerId\`), INDEX \`IDX_49e493dc2eddce0132c0237d68\` (\`project_detail_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`customers\` (\`id\` varchar(36) NOT NULL, \`customer_name\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`img_customer\` varchar(255) NULL, \`date_of_birth\` date NULL, \`cccd\` varchar(255) NULL, \`email\` text NULL, \`gender\` varchar(255) NULL, \`address\` varchar(255) NULL, \`permanent_address\` varchar(255) NULL, \`living_area\` varchar(255) NULL, \`the_product_type\` varchar(255) NULL, \`nationality\` varchar(255) NULL, \`marital_status\` varchar(255) NULL, \`interest\` varchar(255) NULL, \`total_assets\` bigint NULL, \`business_field\` varchar(255) NULL, \`zalo_status\` varchar(255) NULL, \`facebook\` varchar(255) NULL, \`isVip\` tinyint NOT NULL DEFAULT 0, \`level\` int NOT NULL DEFAULT '0', \`importFileId\` varchar(36) NULL, INDEX \`IDX_a1dded0c9e77a3e62a09d20ed8\` (\`customer_name\`), INDEX \`IDX_16a1516d545978de10572498b6\` (\`cccd\`), INDEX \`IDX_46c5f573cb24bdc6e81b8ef250\` (\`phone_number\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
