export const HEADER_MAP = {
    ...
    floor: ['floor'],
    land_area: ['DIỆN TÍCH ĐẤT/DIỆN TÍCH TIM TƯỜNG', 'land_area'],
    usable_area: ['DIỆN TÍCH SÀN XÂY DỰNG/DIỆN TÍCH THÔNG THỦY', 'usable_area'],
    ...
    customer_name: ['HỌ VÀ TÊN KHÁCH HÀNG', 'Tên', 'Họ và Tên', 'Full Name', 'CUSTOMER NAME'],
    date_of_birth: ['NGÀY THÁNG NĂM SINH', 'date_of_birth', 'DOB'],
